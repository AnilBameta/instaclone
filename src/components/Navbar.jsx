...
const Navbar = (props) => {
  ...
  const getLikedPosts = () => {
    axios
      .get("http://localhost:5000/api/users/getLikedPosts")
      ...
      <Wrapper>
        ...
        <Right>
          <IconPallete>
            ...
            <Icon>
              <MapsUgcRoundedIcon style={{ fontSize: "30px" }} />
            </Icon>
            <Icon>
              <ExploreRoundedIcon style={{ fontSize: "30px" }} />
            </Icon>
            <Icon>
              <FavoriteBorderRoundedIcon
                onClick={() => {handleOpen1();getLikedPosts()}}
                style={{ fontSize: "30px" }}
              />
            </Icon>
            <Icon>
          ...
          <ButtonSec>{renderList()}</ButtonSec>
        </Right>
      </Wrapper>
    </Container>
  );
